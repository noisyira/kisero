...
?>
    ...
    <div class="col-md-4">
        ...
        <div class="col-md-12 text-right" style="margin-bottom: 5px;">
            <a type="button"
               class="phone_book"
               data-template-url="/partials/second/tpl/phonebook.html"
...
?>
        ...
        <!--Web phone-->
        <div id="divCallCtrl" ng-controller="webCtrl" class="col-md-12 well" style='vertical-align:middle'>
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                         <div id="divBtnCallGroup" class="btn-group">
                             <button id="btnCall" ng-click="acceptCall()" disabled class="btn btn-tfoms-green" data-content="call">Вызов</button>
                         </div>
                         <div class="btn-group">
     ...
     <!--               <div class="col-md-4 text-left" style="padding: 0">
                        <?/*= Html::a('Добавить', [Yii::$app->controller->id.'/index#/newTask'], ['class' => 'btn btn-warning']);*/?>
                    </div>-->
                    <div class="col-md-4 text-left" style="padding: 0">
