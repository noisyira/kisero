                ...
                <div class="row form-group" ng-show="model.tip_statement == 1">
                    ...
                    <div class="col-md-8">
                        <div class="btn-group" ng-model="res.plaint" bs-radio-group>
                            <label ng-click="setPlaint(0)" class="btn btn-default"><input type="radio" class="btn btn-default" ng-click="setPlaint(0)" value="0"> Обоснованная</label>
                            <label ng-click="setPlaint(1)" class="btn btn-default"><input type="radio" class="btn btn-default"  value="1"> Необоснованная</label>
                        </div>
                    </div>
                </div>
