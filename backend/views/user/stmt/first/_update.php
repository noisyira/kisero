...
<div class="stmt-form">
    ...
    <div ng-init="clearERZ()">
        ...
        <div class="row">
            ...
            <!-- Послушать запись -->
<!--            <div class="col-md-6 text-right" ng-show="recordName">-->
<!--                <div class="videogular-container">-->
<!--                    <videogular vg-theme="config.theme.url" class="videogular-container audio">-->
...
<!--            </div>-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="btn-group" ng-model="model.form_statement" bs-radio-group>
                            <label class="btn btn-default"  ng-click="chForm(0)">
                                <input type="radio" class="btn btn-default" value="0"> Устная</label>
                            <label class="btn btn-default" ng-click="chForm(1)">
    ...
    <div class="row">
        <div class="col-md-4">
            <p>
                <label class="task-erz" for="send" style="font-size: 14px;">Перевести на другого специалиста</label>
                <input type="checkbox" id="send" name="send" ng-model="send" />
            </p>
        </div>
        <div class="col-md-6">
            <div class="form-group" ng-init="transferList()" ng-show="send">
                <!-- Исполнитель -->
                <oi-select
                    id="userList"
                    oi-options="item for (key, item) in userTransferLists"
                    ng-model="transferUser"
        ...
        <div class="col-md-2 text-right">
            <div class="form-group" ng-show="send">
                <button class="btn btn-default" ng-click="transfer()">Перевести</button>
            </div>
