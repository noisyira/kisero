...
<div class="stmt-view">
    ...
    <div cg-busy="myPromise">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="row pd5">
                    ...
                    <div class="col-md-8">
                        <span class="value">
                             <span ng-bind-html="bindHtml(model.group.name)"></span>
                        </span>
                    </div>
                </div>
                ...
                <div class="row pd5">
                    ...
                    <div class="col-md-8">
                        <span class="value">
                             <span ng-bind-html="bindHtml(model.theme.theme_statement)"></span>
                        </span>
                    </div>
                </div>
        ...
        <div class="col-md-12" style="padding: 0">
            ...
            <div class="row">
                <div class="col-md-12" ng-show="model.attachment.length > 0">

                    <ol>
                        <li ng-repeat="item in model.attachment">
                            <a href="send?id={{item.id}}">{{item.file_name}}</a>
                        </li>
                    </ol>
                </div>
